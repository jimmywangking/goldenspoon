<template>
  <div class="role-container">
    ...
    <el-card shadow="hover" class="table-card">
      <el-table :data="roles" v-loading="loading" stripe class="data-table">
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button size="small" @click="togglePermPanel(row)" :disabled="row.isSystem">
    ...
    <el-collapse-transition>
      <div v-if="activePermRoleId !== null" key="perm-panel">
        <el-card shadow="hover" class="perm-card" :class="{ 'perm-card--open': activePermRoleId !== null }">
          <template #header>
...
async function togglePermPanel(row: Role) {
